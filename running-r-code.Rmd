...
![Figure 2.1: RStudio default startup view.](images/Rstudio_startup.png){width=100%}

The version of R you just installed should appear in the main window, or console, here:

![Figure 2.2: Locating R version in RStudio.](images/Rstudio_Rversion.png){width=100%}
...
![Figure 2.3: Important regions in the RStudio interface.](images/Rstudio_startup_regions.png){width=100%}
