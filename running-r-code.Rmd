...
``` {r echo = FALSE, out.width = '100%', fig.cap = "Opening a new script in RStudio."}
knitr::include_graphics(rep("images/Rstudio_newscript.png",1))
```

This should open up a new window in the RStudio interface, as shown in the following image.

``` {r echo = FALSE, out.width = '100%', fig.cap = "Scripts window in RStudio."}
knitr::include_graphics(rep("images/Rstudio_scriptwindow.png",1))
```
...
``` {r echo = FALSE, out.width = '100%', fig.cap = "Find and replace button in the Scripts window of RStudio."}
knitr::include_graphics(rep("images/Rstudio_findreplace.png",1))
```
...
You can assign the outputs of your arithmetic to variables using `<-`, as shown below. To view the contents of the variable, simply type your assigned variable name and press Enter.
...
These are examples of assignment statements. We will cover more assignments of more complex objects in the following section and in subsequent chapters.
