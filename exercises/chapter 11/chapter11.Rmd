...
Just like what you did in the Chapter 10 exercise, you will start by removing potential measurement errors.
...
1. Create a column called `Ox` by adding `O3` and `NO2`. 
