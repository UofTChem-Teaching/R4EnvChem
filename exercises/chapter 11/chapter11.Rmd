...
To prepare the data for the exercises, we first need to transform it to a longer format. This step is done for you and helps in simplifying the following tasks.
