...
You will write a function called `grade_checker` that takes a numeric grade (0 to 100) as its input. The function should return "F" if the grade is less than 60, "D" if the grade is between 60 and 69, "C" if the grade is between 70 and 79, "B" if the grade is between 80 and 89, and "A" if the grade is 90 or above.  
...
test_that("Exercise 4: Conditional Statement", {
  expect_equal(grade_checker(55), "F")
  expect_equal(grade_checker(65), "D")
  expect_equal(grade_checker(75), "C")
  expect_equal(grade_checker(85), "B")
  expect_equal(grade_checker(95), "A")
})
```

------------------------------------------------------------------------

# Exercise 5: Calculate Median
...
# Unittest for Exercise 3
test_that("Exercise 5: Calculate Median", {
