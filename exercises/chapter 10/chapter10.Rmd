...
Before we finish, let's visualize the `Time`(x-axis) vs. `O3`(y-axis) values in the original `data`. By plotting these values, you'll get a clearer idea of any outliers or potentially erroneous data points. 
