---
title: 'Chapter 13: Data Summarization in R'
output:
  html_document:
    df_print: paged
---
...
2. Inside the repository, go to the "Chapter 13" folder.
...
Create a summary table named `summary_EPDM` by calculating the mean, median, minimum, maximum, and standard deviation of the `EPDM` values. Then, make it into a flextable "summary_EPDM_ft". 
...
3. Calculate the mean and median of the `EPDM`, `Polystyrene`, and `Polyethylene` values within each group.  
