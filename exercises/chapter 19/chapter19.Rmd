...
data <- read_csv("2018-01-01_60430_Toronto_ON.csv")
```
...
This exercise will give students practical experience in fitting linear models and interpreting their results, which is a fundamental skill in data analysis.
