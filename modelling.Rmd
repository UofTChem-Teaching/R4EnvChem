...
As we can see, the model outputs are pretty brief and not more more than *Excel*'s outputs. We can use `summary()` to extract more information to better understand our model: 
