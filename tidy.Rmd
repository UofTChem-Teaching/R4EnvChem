...
We will formally introduce the unfamiliar operator `%>%` (pipe) in the next chapter. For now, just remember that there is a way to chain your functions like the above example!
