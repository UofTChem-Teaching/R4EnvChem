...
In order to use this book you will first need to download and install **R** on your computer. The latest build as of May 2021 is v4.1.0. [Download the appropriate version of R for your Operating System here](https://utstat.toronto.edu/cran/).
