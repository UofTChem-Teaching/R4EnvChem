...
ggplot(stJ, aes(x = city, y= conc)) +
  ...
  # outliers
  annotate("rect", xmin = 0.95, xmax = 1.05, ymin = 14.5, ymax = 50, alpha = 0.25, colour = "red") +
  annotate("text", x = 1.10, y = 30, label = "Outliers", colour = "red") +
