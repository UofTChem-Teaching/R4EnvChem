...
The slope here is an approximation for the slope between the min value `a` and max value `d`. Looking at our data in \@ref{fig:sdsMax}, that slope may be a bit shallow consider the large jump in intensity. Let's increase the value of `b` and try again: 
