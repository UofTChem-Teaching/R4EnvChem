...
You can assign a value to a variables using `<-`, as shown below.
...
You can also write you're own functions. Please see [Writing custom functions in R] for additional details.
