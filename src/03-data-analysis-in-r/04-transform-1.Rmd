...
A Couple of things to note: 
  ...
  1. Quotation marks are optional: When creating a new variable in mutate(), you can choose to use or not use quotation marks around the variable name. Both `dil_fct` and `"dil_fct"` will work, but it's more common to omit the quotation marks.
