...
In this case, piping might seem redundant because it only removes the need to specify the first argument explicitly. This is functionally equivalent to:
