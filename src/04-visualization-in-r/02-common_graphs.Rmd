...
Scatter plots display values of two variables, one of which is a *continuous* variable. Each data point ins plotted as an individual point on. You've already learned the basics of scatter plots in Chapter 14. Now, we'll touch upon some things you can do to improve your scatter plots.
