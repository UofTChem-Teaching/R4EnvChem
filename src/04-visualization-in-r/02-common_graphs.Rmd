...
ggplot(data = sumAtl,
  ...
  geom_col() +
  coord_flip() +
  labs(x = "Mean NO~2~ (ppb)",
       y = "City in Atlantic Canada")
```

Not an overly exciting plot, but it's gotten the job done showing the mena NO~2~ concentrations in each of the Atlantic Canada provinces. Let's break the code down:
...
4. We used `labs()` to provide clearer labels for our axes than those defined by the column titles. 
