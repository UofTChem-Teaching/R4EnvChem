...
```{r}
co2 <- read_csv("data/CHM410_lab2/Airbeam2 July 25.csv")
```
...
transectMapAnnotated <- transectMap +  annotate("segment", x = -79.62161, xend = -79.621614, y = 43.635, yend = 43.65395, size=1) +
